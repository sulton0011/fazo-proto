...
const (
	PostService_CreatePost_FullMethodName         = "/fazo.v1.PostService/CreatePost"
	PostService_GetPost_FullMethodName            = "/fazo.v1.PostService/GetPost"
	PostService_GetAllPosts_FullMethodName        = "/fazo.v1.PostService/GetAllPosts"
	PostService_UpdatePost_FullMethodName         = "/fazo.v1.PostService/UpdatePost"
	PostService_DeletePost_FullMethodName         = "/fazo.v1.PostService/DeletePost"
	PostService_SearchPostsByTitle_FullMethodName = "/fazo.v1.PostService/SearchPostsByTitle"
	PostService_LikePost_FullMethodName           = "/fazo.v1.PostService/LikePost"
)
...
func (c *postServiceClient) SearchPostsByTitle(ctx context.Context, in *SearchPostsByTitleRequest, opts ...grpc.CallOption) (*SearchPostsByTitleResponse, error) {
	...
	err := c.cc.Invoke(ctx, PostService_SearchPostsByTitle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPostServiceServer) SearchPostsByTitle(context.Context, *SearchPostsByTitleRequest) (*SearchPostsByTitleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchPostsByTitle not implemented")
}
...
func _PostService_SearchPostsByTitle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostService_SearchPostsByTitle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var PostService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fazo.v1.PostService",
	...
	Metadata: "fazo/v1/post_service.proto",
}
